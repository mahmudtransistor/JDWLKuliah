...
public class TambahKamis extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tambah_kamis);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tambah_kamis, menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_simpan) {
			if(edtnmmatkul.getText().toString().trim().isEmpty()){
				...
				AlertDialog.Builder trans = new AlertDialog.Builder(TambahKamis.this);
				...
				trans.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						DatabaseKamis db = new DatabaseKamis(getApplicationContext());
						...
						Kamis kamis = new Kamis(nmmtakul, kelas, ruang, jam);
						db.addKamis(kamis);
						setResult(RESULT_OK);
						finish();
					}
