...
public class TambahSelasa extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tambah_selasa);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tambah_selasa, menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_simpan) {
			if(edtnmmatkul.getText().toString().trim().isEmpty()){
				...
				AlertDialog.Builder trans = new AlertDialog.Builder(TambahSelasa.this);
				...
				trans.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						DatabaseSelasa db = new DatabaseSelasa(getApplicationContext());
						...
						JadwalSelasa selasa = new JadwalSelasa(nmmtakul, kelas, ruang, jam);
						db.addSelasa(selasa);
						setResult(RESULT_OK);
						finish();
					}
