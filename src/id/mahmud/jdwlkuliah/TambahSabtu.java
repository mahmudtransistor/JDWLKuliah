...
public class TambahSabtu extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tambah_sabtu);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tambah_sabtu, menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_simpan) {
			if(edtnmmatkul.getText().toString().trim().isEmpty()){
				...
				AlertDialog.Builder trans = new AlertDialog.Builder(TambahSabtu.this);
				...
				trans.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						DatabaseSabtu db = new DatabaseSabtu(getApplicationContext());
						...
						Sabtu sabtu = new Sabtu(nmmtakul, kelas, ruang, jam);
						db.addSabtu(sabtu);
						setResult(RESULT_OK);
						finish();
					}
