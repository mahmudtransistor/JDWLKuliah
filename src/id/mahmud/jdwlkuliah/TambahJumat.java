...
public class TambahJumat extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tambah_jumat);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tambah_jumat, menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.action_simpan) {
			if(edtnmmatkul.getText().toString().trim().isEmpty()){
				...
				AlertDialog.Builder trans = new AlertDialog.Builder(TambahJumat.this);
				...
				trans.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						DatabaseJumat db = new DatabaseJumat(getApplicationContext());
						...
						Jumat jumat = new Jumat(nmmtakul, kelas, ruang, jam);
						db.addJumat(jumat);
						setResult(RESULT_OK);
						finish();
					}
